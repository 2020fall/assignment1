...
class TwoLayerNet(object):
    ...
    def loss(self, X, y):
        ...
        a1 = affine_forward(X, layer1.params[0], layer1.params[1])
        r1 = relu_forward(a1)
        a2 = affine_forward(r1, layer2.params[0], layer2.params[1])
        ...
        dr1, dW2, db2 = affine_backward(dx, r1, layer2.params[0], layer2.params[1])
        da1 = relu_backward(dr1, a1)
        dx, dW1, db1 = affine_backward(da1, X, layer1.params[0], layer1.params[1])
